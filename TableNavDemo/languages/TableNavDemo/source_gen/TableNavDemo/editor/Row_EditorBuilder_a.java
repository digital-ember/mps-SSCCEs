...
/*package*/ class Row_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createPartialTable_x9dt5l_a_0();
  }

  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_x9dt5l_a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createPartialTable_x9dt5l_a_0() {
    return createPartialTable_x9dt5l_a(getEditorContext(), myNode);
  }
  public Grid createChildsHorizontal_x9dt5l_a0(final EditorContext editorContext, final SNode node) {
    ...
    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(MetaAdapterFactory.getContainmentLink(0x8bbc6835af784affL, 0xadb1795fe9a60846L, 0x7970127f6e0f9ae0L, 0x7970127f6e1312dcL, "cells"))) {};
    ...
    try {
      ...
      int x = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x8bbc6835af784affL, 0xadb1795fe9a60846L, 0x7970127f6e0f9ae0L, 0x7970127f6e1312dcL, "cells"));
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (x < ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x8bbc6835af784affL, 0xadb1795fe9a60846L, 0x7970127f6e0f9ae0L, 0x7970127f6e1312dcL, "cells"))).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x8bbc6835af784affL, 0xadb1795fe9a60846L, 0x7970127f6e0f9ae0L, 0x7970127f6e1312dcL, "cells"))).getElement(x) : null), MetaAdapterFactory.getContainmentLink(0x8bbc6835af784affL, 0xadb1795fe9a60846L, 0x7970127f6e0f9ae0L, 0x7970127f6e1312dcL, "cells"));
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x8bbc6835af784affL, 0xadb1795fe9a60846L, 0x7970127f6e0f9ae0L, 0x7970127f6e1312dcL, "cells"))).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, MetaAdapterFactory.getContainmentLink(0x8bbc6835af784affL, 0xadb1795fe9a60846L, 0x7970127f6e0f9ae0L, 0x7970127f6e1312dcL, "cells"), editorContext);
